...
public class GeneratedDOAuth2UserDaoImpl extends TypeDaoImpl<DOAuth2User, java.lang.Long> 
   ...
   // ------ END DaoImpl overrides -----------------------------
	 ...
	 */
	public final DOAuth2User findByEmail(java.lang.String email) {
	 ...
	 * @return the unique DOAuth2User for the specified attribute
	 */
	public final DOAuth2User findByUsername(java.lang.String username) {
	 ...
	 */
	public DOAuth2User persist(java.lang.String email, 
                java.lang.String displayName, 
                java.lang.String profileLink, 
                java.util.Collection roles, 
                java.lang.String thumbnailUrl, 
                java.lang.String username) {
            DOAuth2User domain = findByEmail(email);
            if (null == domain) {
                domain = new DOAuth2User();
                domain.setDisplayName(displayName);
                domain.setEmail(email);
