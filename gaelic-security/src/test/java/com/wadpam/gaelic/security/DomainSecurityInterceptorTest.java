 ...
 * @author os
 */
public class DomainSecurityInterceptorTest {
    static final Logger LOG = LoggerFactory.getLogger(DomainSecurityInterceptorTest.class);
    
    MockHttpServletRequest request;
    MockHttpServletResponse response;
    GaelicServlet servlet;
    
    public DomainSecurityInterceptorTest() {
