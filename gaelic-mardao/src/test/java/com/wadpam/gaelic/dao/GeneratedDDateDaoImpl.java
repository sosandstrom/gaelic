...
public class GeneratedDDateDaoImpl extends TypeDaoImpl<DDate, java.lang.Long> 
    ...
    /** Default constructor */
   public GeneratedDDateDaoImpl() {
      super(DDate.class, java.lang.Long.class);
   }
   ...
   protected DaoImpl getManyToOneDao(String columnName) {
    ...
    @Override
    protected Object getDomainProperty(DDate domain, String name) {
        Object value;
        // simple key?
    ...
    @Override
    protected void setDomainProperty(final DDate domain, final String name, final Object value) {
        // simple key?
        if (COLUMN_NAME_ID.equals(name)) {
    ...
    @Override
    protected void setDomainStringProperty(final DDate domain, final String name, final Map<String, String> properties) {
   ...
   // ------ END DaoImpl overrides -----------------------------
        ...
        /**
         * @return the simple key for specified DDate domain object
         */
        public Long getSimpleKey(DDate domain) {
            if (null == domain) {
                return null;
            }
            return domain.getId();
         ...
         * @return the simple key for specified DDate domain object
         */
        public void setSimpleKey(DDate domain, Long id) {
            domain.setId(id);
        }
        ...
        public String getCreatedBy(DDate domain) {
            if (null == domain) {
                return null;
            }
        ...
        public void _setCreatedBy(DDate domain, String creator) {
        ...
        public String getUpdatedBy(DDate domain) {
            if (null == domain) {
                return null;
            }
        ...
        public void _setUpdatedBy(DDate domain, String updator) {
        ...
        public Date getCreatedDate(DDate domain) {
            if (null == domain) {
                return null;
            }
        ...
        public void _setCreatedDate(DDate domain, Date date) {
        ...
        public Date getUpdatedDate(DDate domain) {
            if (null == domain) {
                return null;
            }
        ...
        public void _setUpdatedDate(DDate domain, Date date) {
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DDate> queryByCreatedBy(java.lang.String createdBy) {
	 ...
	 * @return an Iterable of keys to the DDates with the specified attribute
	 */
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DDate> queryByCreatedDate(java.util.Date createdDate) {
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DDate> queryByStartDate(java.util.Date startDate) {
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DDate> queryByUpdatedBy(java.lang.String updatedBy) {
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DDate> queryByUpdatedDate(java.util.Date updatedDate) {
	 ...
	 */
	public DDate persist(		java.lang.Long id, 
